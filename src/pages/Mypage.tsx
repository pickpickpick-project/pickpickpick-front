...
import { getOrderList, getOrderStatus, handlePaymentCancel } from '../api/order';
                    ...
                    pageItems.map((item: any, index: number) => (
                        ...
                        <td>{
                                ...
                                ? <div style={{display:"flex", alignItems:"center"}}>
                                    <h3>결제 완료</h3>
                                    <button onClick={() => onClickOrderStatusComplete(item)}>구매 확정</button>
                                    <button onClick={() => onClickOrderStatusCancel(item)}>구매 취소</button>
                                </div>
                                :   item.orderStatus === "COMPLETE" ? "구매확정" 
                                : "구매취소" 
                                }</td>
                        </tr>
                    )) : 
